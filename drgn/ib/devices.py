...
#     print(ib_device.port_data[0].immutable)
    print("ib_device.node_guid: %x" % ib_device.node_guid)
...
#     print(ib_device.port_data[i])
    print(ib_device)
    for node in radix_tree_for_each(ib_device.client_data):
        ib_client = Object(prog, 'u32', address=node[1].value_())
        print(ib_client)
    print("\n=======================")

highest_client_id = prog['highest_client_id']
print("highest_client_id")
print(highest_client_id)
