...
#     print(devlink.ops.reload_up)
    rate_domain = devlink.rate_domain
    shared = rate_domain.shared
    if shared:
        print(rate_domain)
...
#         for port in list_for_each_entry('struct devlink_port', rate_domain.port_list.address_of_(), 'list'):
...
#                 print(port.devlink_rate)
        ...
        for devlink_rate in list_for_each_entry('struct devlink_rate', rate_domain.rate_list.address_of_(), 'list'):
            print("=======================================================")
